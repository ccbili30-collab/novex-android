...
data class ChatSessionEntity(
    ...
    /** Standing text-style instruction (文字文风) appended after the latest user turn. Blank/NULL = off. */
    ...
    /** Typed Novex conversation configuration, serialized only at the persistence boundary. */
