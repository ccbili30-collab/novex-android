...
class NovexUserRequestTest {
    ...
    @Test fun contextTokensStayExactAndReadable() {
        assertEquals("32,000",compactContextTokens(32000))
        assertEquals("1,000,000",compactContextTokens(1000000))
        assertEquals("1,500",compactContextTokens(1500))
        assertEquals("990",compactContextTokens(990))
        assertEquals("339,250",compactContextTokens(339250))
        assertTrue(compactContextTokens(Int.MAX_VALUE).length >= 10)
    }
}
